...
<body>
    ...
    <div class="products-grid mb-5">
                    ...
                    <?php foreach ($category->subCategories as $subCategory): ?>
                        <li><?= $subCategory->name ?>
                            <?php foreach ($subCategory->subSubCategories as $subSubCategory): ?>
                                <a class="dropdown-item" href="<?= Url::to(['site/index', 'subsubcategory_id' => $subSubCategory->id]) ?>"><?= $subSubCategory->name ?></a>
                            <?php endforeach; ?>
                        </li>
                    <?php endforeach; ?>
                </ul>
        ...
        <div class="dropdown">
            <a class="btn btn-secondary dropdown-toggle" href="<?= Url::to(['site/index']) ?>">Barchasi</a>
        </div>
    </div>
